...
struct sequence<T, 0> {
    ...
    typedef typename sequence_iterator<cuda::sequence<T, 0> >::type iterator_type;
    ...
    __host__
    sequence(::sequence<T, 0> s) : m_d(s.m_d), m_l(s.m_l) {}
    __host__ __device__
...
struct sequence {
    ...
    typedef typename sequence_iterator<cuda::sequence<T, D> >::type iterator_type;
    ...
    __host__
    sequence(const ::sequence<T, D>& s) : m_d(s.m_d), m_s(s.m_s) {}
